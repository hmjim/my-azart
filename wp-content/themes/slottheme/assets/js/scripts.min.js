...
jQuery(document).ready(function($) {
	...
	$('.rating-table').stacktable();

	$(".tbl_developers_more").click(function(e) {
		e.preventDefault();
		var p = $(this).closest('.tbl_developers');
		var txt = p.hasClass('show') ? 'Показать еще' : 'Скрыть';
		$(this).text(txt);
		p.toggleClass('show');
	});
