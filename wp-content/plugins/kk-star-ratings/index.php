    ...
    class BhittaniPlugin_kkStarRatings extends BhittaniPlugin
    {
        ...
        */
        public function css_custom()
        {
            ...
            $star_gray = str_replace('//', '/', parse_url(parent::get_options('kksr_stars_gray'))['path']);
            $star_yellow = str_replace('//', '/', parse_url(parent::get_options('kksr_stars_yellow'))['path']);
            $star_orange = str_replace('//', '/', parse_url(parent::get_options('kksr_stars_orange'))['path']);
